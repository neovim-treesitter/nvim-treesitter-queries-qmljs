# nvim-treesitter-queries-qmljs

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-qmljs/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-qmljs/actions/workflows/validate.yml)

Neovim tree-sitter queries for **qmljs**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-qmljs",
...
- [ ] Changes are scoped to `qmljs` — do not include files for other languages
